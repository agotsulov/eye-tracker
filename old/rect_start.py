...
screen = pygame.display.set_mode((0, 1000))
...
model = utility.load_model('./model_rect.pth', device, train.ConvNet(16))
...
while not quit:
    ...
    eyes, shape = face_detector.predict(frame)
    ...
    if eyes is not None and model is not None:
        ...
        # print(out)
        _x, _y, _w, _h = utility.uncut(out, 16, 1920, 1080)

        pygame.draw.rect(screen, (0, 0, 255), (_x, _y, _w, _h))
